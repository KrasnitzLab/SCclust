...
test_that("pinmat reordered full build works as expected for nyu003", {
...
test_that("calc_pinmat function works as expected for GL6.1", {
  ...
  res <- calc_pinmat(gc_df, segment_df, dropareas=dropareas)
...
test_that("calc_pinmat function works as expected for nyu003", {
